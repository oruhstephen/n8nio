...
def get_morning_watchlist():
    ...
    try:
        ...
        # ==========================================
        print(f"\nDownloading 2-month history for {len(top_40)} symbols to calculate Alignments and Over-Extension...")
            ...
            if current_time - last_n8n_trigger >= 60:
                ...
                for sym, metrics in market_data.items():
                    ...
                    if cum_vol > 50000 and current_price > 0: 
                        ...
                        print(f"[{sym}] +{p_change:.2f}% | Dist: {vwap_distance:.2f}% | Align: {alignment} | Ext: +{extension_pct:.1f}% | Danger: {is_over_extended}")
